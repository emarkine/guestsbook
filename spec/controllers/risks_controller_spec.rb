...
RSpec.describe RisksController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all risks as @risks" do
      ...
      expect(assigns(:risks)).to eq([risk])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested risk as @risk" do
      ...
      expect(assigns(:risk)).to eq(risk)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new risk as @risk" do
      ...
      expect(assigns(:risk)).to be_a_new(Risk)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created risk as @risk" do
        post :create, {:risk => valid_attributes}, valid_session
        expect(assigns(:risk)).to be_a(Risk)
        expect(assigns(:risk)).to be_persisted
      end

      it "redirects to the created risk" do
        post :create, {:risk => valid_attributes}, valid_session
        expect(response).to redirect_to(Risk.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved risk as @risk" do
        post :create, {:risk => invalid_attributes}, valid_session
        expect(assigns(:risk)).to be_a_new(Risk)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested risk" do
        risk = Risk.create! valid_attributes
        put :update, {:id => risk.to_param, :risk => new_attributes}, valid_session
        risk.reload
      ...
      it "redirects to the risk" do
        risk = Risk.create! valid_attributes
        put :update, {:id => risk.to_param, :risk => valid_attributes}, valid_session
        expect(response).to redirect_to(risk)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the risk as @risk" do
        risk = Risk.create! valid_attributes
        put :update, {:id => risk.to_param, :risk => invalid_attributes}, valid_session
        expect(assigns(:risk)).to eq(risk)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the risks list" do
      risk = Risk.create! valid_attributes
      delete :destroy, {:id => risk.to_param}, valid_session
      expect(response).to redirect_to(risks_url)
    end
  end
